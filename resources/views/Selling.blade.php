...
@section('content')
    ...
    <div class="container">
        <br />
        <h1 align="center">Post Your Add</h1>
        <form action="/Selling" method="post">
            ...
            <div class="form-group">
                ...
                <textarea name="discription" class="form-control" rows="3" id="#textarea"
                    placeholder="One of the cleanes cars in Islamabad...... " required=""></textarea>
                <div class="counter">
            ...
            <div class="form-group">
              <h5>SET YOUR FAIR DEMAND</h5>
                ...
                <div class="price">
                    ...
                    <input id="price" name="price" spellcheck="false" class="" autocomplete="off" type="number" value=""
                        required="" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input name="location" type="text" class="form-control" placeholder="I-10, Islamabad"
                    onkeyup="validate(this)" required="" />
            </div>
            <h5>You Will Be Shown As:</h5>
            <div class="form-group">
                <label for="">Name</label>
                <input name="name" type="text" class="form-control" placeholder="Ali Hassan" name="name"
                    onkeyup="validate(this)" required="" />
            </div>
            <div class="form-group displaynum">
                <span for="">Your Contct Number</span>
                <input name="number" type="text" class="form-control" placeholder="0321XXXXXXX" onkeyup="validate(this)"
                    required="" />
            </div>
            <div class="form-group">
                <input type="submit" value="POST" id="#submit" class="btn login_btn" />
            </div>
            <br>
        </form>
    </div>
